    ...
    <div>
          ...
          <div className="mx-3 mt-16 max-w-7xl px-6">
            <div className="max-w-3xl">
              {/* <span className="inline-flex rounded border border-blue-400/30 bg-blue-500/20 px-5 py-2 text-sm font-semibold uppercase tracking-[4px] text-cyan-300">
                Cillages One • Office Automation
              </span> */}
              ...
              <p className="mt-5 sm:mt-8 max-w-2xl text-sm sm:text-lg leading-8 text-gray-200">
                ...
                meeting rooms, security, access control, and energy management.
                Cillages One creates connected workspaces that improve
                efficiency, productivity, security, and employee experience.
              </p>

              {/* Stats */}

              <div className="mt-8 sm:mt-16 grid grid-cols-2 gap-8 sm:grid-cols-4">
                <div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-cyan-700 via-cyan-600 to-blue-600 py-24">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="mt-8 text-lg leading-8 text-cyan-100 max-w-3xl mx-auto">
